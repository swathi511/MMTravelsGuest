...
import com.hjsoftware.mmtravelsguest.DrawerItemCustomAdapter;
import com.hjsoftware.mmtravelsguest.NavigationData;
import com.hjsoftware.mmtravelsguest.R;
import com.hjsoftware.mmtravelsguest.SessionManager;
import com.hjsoftware.mmtravelsguest.fragments.SpecificBookingFragment;
...
public class SpecificBookingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment fragment = new SpecificBookingFragment();
        FragmentManager fragmentManager = getSupportFragmentManager();
        fragmentManager.beginTransaction().add(R.id.content_frame, fragment, "Edit Booking").commit();
                ...
                if (getSupportFragmentManager().getBackStackEntryCount() > 0) {
                    ...
                    toolbar.setNavigationOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            fragmentTransaction.remove(getSupportFragmentManager().findFragmentByTag("Edit Booking"));
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                break;
//            case 2:
//                Intent m=new Intent(SpecificBookingActivity.this,DutySlipActivity.class);
