...
import com.hjsoftware.mmtravelsguest.fragments.ChangePasswordFragment;
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                break;
//            case 2:
//                Intent m=new Intent(ChangepasswordActivity.this,DutySlipActivity.class);
            ...
            case REQUEST_LOCATION:
                ...
                switch (resultCode) {
                    case Activity.RESULT_OK: {
                        ...
                        Toast.makeText(ChangepasswordActivity.this, "Please wait.. Getting Location!", Toast.LENGTH_LONG).show();
                       /* if(sbMsg!=null) {
                            sbMsg.dismiss();
                        }*/
                        break;
                    ...
                    case Activity.RESULT_CANCELED: {
                        Toast.makeText(ChangepasswordActivity.this, "GPS should be enabled for the app to run!", Toast.LENGTH_LONG).show();
                        finish();
                        break;
                    }
                    default: {
