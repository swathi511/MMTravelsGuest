...
public class DrawerItemCustomAdapter extends ArrayAdapter<NavigationData> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView imageViewIcon = (ImageView) listItem.findViewById(com.hjsoftware.mmtravelsguest.R.id.imageViewIcon);
        TextView textViewName = (TextView) listItem.findViewById(com.hjsoftware.mmtravelsguest.R.id.textViewName);
